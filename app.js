...
// const selectedFile = document.getElementById('train_data').files[0];
// var reader = new FileReader();
// var fileToRead = document.querySelector('train_data').files[0];
...
// console.log(uploadTrainingData(onsubmit))

function trainData(event) {
